...
class OnboardingThreeScreen extends StatelessWidget {
          ...
          child: Scaffold(
              body: SizedBox(
                  ...
                  child: Column(children: [
                    ...
                    _buildFortyFiveSection(context),
                    SizedBox(height: 5.v)
                  ]))));
  }
  ...
  Widget _buildInfoSection(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
          ...
          SizedBox(
              width: 341.h,
              child: Text("Stay entertained with our curated selection of TV shows and magazines, adding a touch of enjoyment to your 'La noche' experience.",
                  maxLines: 5,
                  overflow: TextOverflow.ellipsis,
                  textAlign: TextAlign.center,
  ...
  Widget _buildFortyFiveSection(BuildContext context) {
    return Padding(
