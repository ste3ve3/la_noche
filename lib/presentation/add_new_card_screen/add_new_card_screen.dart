...
/// Section Widget
Widget _buildNameEditText(BuildContext context) { return CustomTextFormField(controller: nameEditTextController, hintText: "Daniel Austin"); } 
/// Section Widget
Widget _buildNumberEditText(BuildContext context) { return CustomTextFormField(controller: numberEditTextController, hintText: "6373 2728 4797 4679"); } 
/// Section Widget
Widget _buildExpiryDateEditText(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(right: 8.h), child: CustomTextFormField(controller: expiryDateEditTextController, hintText: "02/30"))); } 
/// Section Widget
Widget _buildCvvEditText(BuildContext context) { return Expanded(child: Padding(padding: EdgeInsets.only(left: 8.h), child: CustomTextFormField(controller: cvvEditTextController, hintText: "190", textInputAction: TextInputAction.done))); } 
/// Section Widget
...
/// Section Widget
Widget _buildAddNewCardButton(BuildContext context) { return CustomElevatedButton(text: "Add New Card", margin: EdgeInsets.only(left: 24.h, right: 24.h, bottom: 49.v)); } 
