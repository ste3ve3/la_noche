import '../refund_method_screen/widgets/refundmethod_item_widget.dart';
...
class RefundMethodScreen extends StatelessWidget {
  const RefundMethodScreen({Key? key}) : super(key: key);
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(children: [
                  ...
                  _buildRefundMethod(context),
                  Spacer(),
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Padding(
                      padding: EdgeInsets.only(top: 16.v),
                      child: Text("Paid: 479.5", style: CustomTextStyles.bodyLarge18),
                    ),
                    Padding(
                        padding: EdgeInsets.only(top: 16.v, left: 16.h),
                        child: Text("Refund: 383.8",
                            style: theme.textTheme.titleMedium))
                  ])
                ])),
            bottomNavigationBar: _buildConfirmCancellation(context)));
  }
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return CustomAppBar(
        ...
        title: AppbarTitle(
            text: "Cancel Lounge Booking", margin: EdgeInsets.only(left: 16.h)));
  }

  Widget _buildRefundMethod(BuildContext context) {
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return RefundmethodItemWidget();
        });
  }

  Widget _buildConfirmCancellation(BuildContext context) {
